...
class Parser:
    def __init__(self):
        ...
        self.main_dlg.title('txt-xlsx转换工具')
        self.main_dlg.iconbitmap('txt2xlsx.ico')
    ...
    def __trans__(self):
        try:
            ...
            if os.path.exists(r'convert_result.xlsx'):
                result_book = load_workbook('convert_result.xlsx')
            ...
            source_file.close()
            result_book.save('convert_result.xlsx')
